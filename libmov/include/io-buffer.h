 ...
 * @Last Modified time: 2021-10-19 22:12:45
 */
...
static inline int io_buffer_read(void *param, void *data, uint64_t bytes)
{
    return ((io_buffer*)param)->read((uint8_t*)data, (size_t)bytes);
}

static inline int io_buffer_seek(void *param, int64_t offset)
{
    return ((io_buffer *)param)->seekr(offset);
}

static inline int64_t io_buffer_tell(void *param)
{
